...
model_txt_path = os.path.join(os.path.dirname(__file__), "assets/model.txt")
...
class PoseEstimator:
    ...
    def _get_full_model_points(self, filename=model_txt_path):
    ...
    def draw_axis(self, img, R, t):
        points = np.float32([[30, 0, 0], [0, 30, 0], [0, 0, 30], [0, 0, 0]]).reshape(
            -1, 3
        )
